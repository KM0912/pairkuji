...
export function SubstitutionHint({
  ...
  return (
    <div role="status" aria-live="polite" className="fixed bottom-20 left-1/2 transform -translate-x-1/2 bg-secondary px-4 py-2 rounded-lg shadow-level-3 z-toast">
